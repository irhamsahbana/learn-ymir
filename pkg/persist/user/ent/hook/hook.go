...
import (
	...
	"github.com/irhamsahbana/learn-ymir/pkg/persist/user/ent"
)
...
// function as Ymir mutator.
type YmirFunc func(context.Context, *ent.YmirMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f YmirFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.YmirMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.YmirMutation", m)
}
